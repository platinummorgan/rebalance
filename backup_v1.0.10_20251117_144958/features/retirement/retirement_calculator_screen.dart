      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                AppLocalizations.of(context)!.retirementSimulationDescription,
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.yourRetirementPlan,
              style: const TextStyle(
                fontSize: 18,
            ...
            // Current Savings
            _buildSliderInput(
              label: AppLocalizations.of(context)!.currentSavings,
            ...
            _buildSliderInput(
              label: AppLocalizations.of(context)!.monthlyContribution,
            ...
            _buildSliderInput(
              label: AppLocalizations.of(context)!.yearsUntilRetirement,
            ...
            _buildSliderInput(
              label: AppLocalizations.of(context)!.desiredMonthlyIncome,
            ...
            // Retirement Duration
            _buildSliderInput(
              label: AppLocalizations.of(context)!.yearsInRetirement,
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              AppLocalizations.of(context)!.successProbabilityLabel,
              style: const TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
              ),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.grade(result.grade),
                    style: const TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
            ...
            _buildStatRow(
              AppLocalizations.of(context)!.atRetirement,
              CurrencyFormatter.format(result.projectedAtRetirement, 'USD'),
              Icons.savings,
            ),
            _buildStatRow(
              AppLocalizations.of(context)!.medianAfterRetirement,
              CurrencyFormatter.format(result.medianFinalBalance, 'USD'),
              Icons.account_balance,
            ),
            _buildStatRow(
              AppLocalizations.of(context)!.bestCase90th,
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.outcomeDistribution,
              style: const TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
              ),
            ...
            const SizedBox(height: 8),
            Text(
              AppLocalizations.of(context)!.outcomeLikelihood,
    ...
    if (result.probabilityOfSuccess < 0.70) {
      ...
      recommendations.add(
        _Recommendation(
          icon: Icons.savings,
          color: Colors.orange,
          text: AppLocalizations.of(context)!.considerIncreasingContributions(
            CurrencyFormatter.format(requiredSavings, 'USD'),
          ),
        ),
      );
    }
    ...
    if (result.probabilityOfSuccess >= 0.90) {
      recommendations.add(
        _Recommendation(
          ...
          color: Colors.green,
          text: AppLocalizations.of(context)!.excellentOnTrack,
        ),
      );
    }
    ...
    if (_desiredMonthlyIncome > safeWithdrawal * 1.2) {
      recommendations.add(
        _Recommendation(
          icon: Icons.warning,
          color: Colors.red,
          text: AppLocalizations.of(context)!.incomeExceedsSafeWithdrawal(
            CurrencyFormatter.format(_desiredMonthlyIncome, 'USD'),
            CurrencyFormatter.format(safeWithdrawal, 'USD'),
          ),
        ),
      );
    }
      ...
      recommendations.add(
        _Recommendation(
          ...
          text: AppLocalizations.of(context)!
              .timeIsAdvantage(_yearsUntilRetirement.toString()),
        ),
      );
    }
    ...
    if (recommendations.isEmpty) {
      recommendations.add(
        _Recommendation(
          ...
          color: Colors.blue,
          text: AppLocalizations.of(context)!.planReasonable,
        ),
      );
    }
