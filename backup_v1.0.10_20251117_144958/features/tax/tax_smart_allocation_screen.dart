...
class TaxSmartAllocationScreen extends ConsumerWidget {
  ...
  Widget _buildGate(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: Text(AppLocalizations.of(context)!.taxSmartAllocation)),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizations.of(context)!.unlockTaxOptimization,
                style:
                    const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 8),
              Text(
                AppLocalizations.of(context)!.taxOptimizationDescription,
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.estimatedAnnualTaxSavings,
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text(
                  currency.format(a.optimizedDrag),
                  style: const TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: Colors.green,
            ...
            Text(
              AppLocalizations.of(context)!
                  .potentialSavings(currency.format(a.savings)),
              style: const TextStyle(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.suggestedReallocation,
              style: Theme.of(context)
                  .textTheme
                  .titleMedium
                  ?.copyWith(fontWeight: FontWeight.w600),
            ...
            for (final m in a.moves)
              ListTile(
                ...
                subtitle: Text(
                  AppLocalizations.of(context)!.estimatedYearlyImpact(
                    a.currencyFmt.format(m.annualImpact),
                  ),
                ),
              ),
          ],
...
class _Assumptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExpansionTile(
      title: Text(AppLocalizations.of(context)!.assumptionsAndMethodology),
