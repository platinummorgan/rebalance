...
class ScenarioEngineScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return settingsAsync.when(
      ...
      error: (e, st) => Scaffold(
        appBar:
            AppBar(title: Text(AppLocalizations.of(context)!.scenarioEngine)),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _slider(
                label: AppLocalizations.of(context)!.expectedReturn,
              ...
              _slider(
                label: AppLocalizations.of(context)!.volatility,
              ...
              _slider(
                label: AppLocalizations.of(context)!.years,
              ...
              _slider(
                label: AppLocalizations.of(context)!.goalAmount,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              _statRow(
                AppLocalizations.of(context)!.successProbability,
                pct.format(result.successProbability),
              ),
              _statRow(
                AppLocalizations.of(context)!.medianEnding,
                CurrencyFormatter.format(result.medianEnding, currency),
              ),
              _statRow(
                AppLocalizations.of(context)!.tenthPercentile,
                CurrencyFormatter.format(result.p10Ending, currency),
              ),
              _statRow(
                AppLocalizations.of(context)!.ninetiethPercentile,
                CurrencyFormatter.format(result.p90Ending, currency),
              ),
              const SizedBox(height: 12),
              Text(
                AppLocalizations.of(context)!.simulationsYears(
                  result.simulations.toString(),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.distributionSortedOutcomes,
              style: const TextStyle(fontWeight: FontWeight.w600),
            ),
            const SizedBox(height: 12),
            SizedBox(
